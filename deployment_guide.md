...
* **LanMan Project Archive:** [Download .zip](https://www.dropbox.com/scl/fi/4otx6x06w3110lutl1oq4/LanMan_v3.zip?rlkey=sob0kyeiyybpuopr1ytxqtmx8&st=3nbiu6fu&dl=0)
...
| :--- | :--- | :--- |
| **LanMan_CRON_Standard_Sweep** | `\www\cron_sweep/index.php` | Repeat every 5-60 Minutes |
| **LanMan_CRON_Full_Sweep+Ports** | `\www\cron_sweep_full/index.php` | Repeat every 12-24 Hours (give 5-10min space between standard sweep) |
| **LanMan_CRON_Notifications** | `\www\cron_notifications/index.php` | Repeat every 30 Minutes Depending on sweep times |
| **LanMan_CRON_clean** | `\www\cron_clean/index.php` | Repeat every 24 Hour |
or
